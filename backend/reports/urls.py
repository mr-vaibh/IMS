...
from .views import stock_report_pdf, movement_report_pdf, inventory_valuation_pdf, low_stock_report_pdf, audit_report_pdf, adjustment_report_pdf
...
urlpatterns = [
    ...
    path("adjustments/pdf", adjustment_report_pdf)
]
